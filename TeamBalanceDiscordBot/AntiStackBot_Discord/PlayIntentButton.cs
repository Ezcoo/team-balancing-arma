    ...
    public static class PlayIntentButton
    {
        ...
        private static string BuildMenuContent(int currentCount)
        {
            return "------------------------------------------------------------------------\n**🙋 Looking to play?**\n\n" +
                ...
                "- **I want to play** to join the interested list using your saved settings (first time, I'll DM you to set them up).\n" +
                "- **Settings** anytime to change how many players it takes to notify you and how long you're willing to wait. \n- **I don't want to play anymore (now)** to drop off the list.\n";
        }
